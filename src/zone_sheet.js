...
function zone_sheet() {
  ...
  //
  //Checks if a value if a fomular if it starts with '='or '#'
  ...
  // Zone_sheet core object
  var jexcel = function (el, options) {
    // Create zone_sheet object
    var obj = {};
    obj.options = {};
    ...
    obj.openFilter = function (columnId) {
      if (!obj.options.filters) {
        console.log("Zone_sheet: filters not enabled.");
      } else {
      ...
      if (x1 != null) {
        ...
        for (var i = borderLeft; i <= borderRight; i++) {
          if (
            ...
            obj.colgroup[i].style &&
            obj.colgroup[i].style.display != "none"
          ) {
            // Top border
    ...
    obj.updateScroll = function (direction) {
      // Zone_sheet Container information
      var contentRect = obj.content.getBoundingClientRect();
      var x1 = contentRect.left;
      var y1 = contentRect.top;
          ...
          if (e.target.classList.contains("jexcel_row")) {
            ...
            if (
              ...
              if (jexcel.current.isRowMerged(rowId).length) {
                console.error("Zone_sheet: This row is part of a merged cell");
              } else if (
  ...
  jexcel.helpers = (function () {
    ...
    component.getCoordsFromColumnName = function (columnName) {
      ...
      if (t) {
        ...
        code--;
        // Make sure zone_sheet starts on zero
        if (code < 0) {
          code = 0;
        }
  ...
  if (typeof jQuery != "undefined") {
    (function ($) {
      $.fn.zone_sheet = $.fn.jexcel = function (mixed) {
